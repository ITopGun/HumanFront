      ...
      <div className="landing-bg home-text">
        ...
        <Container>
          ...
          <div className="text-center text-og">
            <p className="pt-0 pb-0 pl-4 pr-4">
            Друга характеристика на личните отношения е и ролята, която всеки от Вас заема както в обществото, така и в дома.</p>
          </div>
          <p className="pt-0 pb-0 pl-4 pr-4">За всекиго е отреден много специфичен начин на взаимодействие и когато сте наясно с него, Вие ще можете да поддържате една много голяма лекота при свързването си с другия.
          </p>
            {" "}
            <p className="pt-0 pb-0 pl-4 pr-4">
